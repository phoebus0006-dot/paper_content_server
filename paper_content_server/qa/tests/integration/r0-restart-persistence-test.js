...
function spawnSrv(tmpDir, envOverrides) {
  ...
  processes.push(child); if(child.pid) pids.push(child.pid); return { child: child, dataDir: tmpDir, port: env.PORT, base: b };
}
...
test('r0-restart-persistence-test.js', async () => { await main(); });
