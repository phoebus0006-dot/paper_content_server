...
t('NO_SNAPSHOT',allSrc.indexOf('../snapshot/')===-1,'');
t('NO_PUBLICATION',allSrc.indexOf('../publication/')===-1,'');
t('NO_SERVER',allSrc.indexOf('server.js')===-1,'');
t('NO_APP',allSrc.indexOf('../app/')===-1,'');
t('NO_EPAPER',allSrc.indexOf('../epaper/')===-1,'');
